...
class MainWindow:
    ...
    def __init__(self):
        ...
        self.indicator = appindicator.Indicator.new(
            "mauna-power-manager", "mauna-pm-balanced-symbolic", appindicator.IndicatorCategory.APPLICATION_STATUS)
        self.indicator.set_status(appindicator.IndicatorStatus.ACTIVE)
        self.indicator.set_icon("mauna-pm-powersave-symbolic")
        self.window.set_wmclass("mauna-power-manager", "mauna-power-manager")
    ...
    def init(self):
        ...
        self.indicator.set_title(_("Mauna Power Manager"))
        ...
        if "mode" in data:
            if self.current_mode != data["mode"]:
                ...
                if self.current_mode == "powersave":
                    ...
                    self.indicator.set_icon("mauna-pm-balanced-symbolic")
                else:
                    self.power_mode.set_label(_("Enable Powersave"))
                    self.indicator.set_icon("mauna-pm-performance-symbolic")
...
###### Window functions ######
    ...
    def quit_event(self, widget):
        os.unlink("/run/user/{}/mpm/{}".format(os.getuid(),os.getpid()))
        Gtk.main_quit()
